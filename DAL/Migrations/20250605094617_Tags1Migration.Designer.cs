...
namespace DAL.Migrations
{
    ...
    [Migration("20250605094617_Tags1Migration")]
    partial class Tags1Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Model.Follow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Model.Follow", b =>
                {
                    b.HasOne("Model.AppUser", "Follower")
                        .WithMany()
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("Model.AppUser", "Followee")
                        .WithMany()
